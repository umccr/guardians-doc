...
|----|-------------|---------------------|
| DCREQ-1 | The invoker can provide a list of specific objects to be copied and provide this in some easily constructable form when invoking the copy service | See NF-2 – the list of objects to copy could be many megabytes – so cannot fit on a command line (for instance) |
